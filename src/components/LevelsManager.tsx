          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full bg-slate-950 border border-slate-700 rounded-xl px-4 py-3 text-xs text-white focus:border-indigo-500 focus:outline-none"
              >
                <option value="">نفس القناة التي أرسل فيها العضو الرسالة (افتراضي)</option>
                {channels.map(c => (
              ...
              <p className="text-[11px] text-slate-400 flex items-center gap-1.5 mt-1">
                ...
                اختر نفس القناة، أو حدد قناة مخصصة مثل <code>#level-up</code> أو <code>#bot-commands</code>.
              </p>
            </div>
